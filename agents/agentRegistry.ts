...
| Applicant               | HAS_NOTES          | Note                         |
    ...
    fewshot: [{ question: 'What honor has Sarah Primrose achieved?', answer: "MATCH (a:Applicant) WHERE a.LastName = 'Primrose' AND a.FirstName = 'Sarah' MATCH (a)-[:HAS]-(h:Honor) RETURN h;" },
            ...
            { question: 'What state bar has Michael Sutton been admitted?', answer: "MATCH (a:Applicant) WHERE a.LastName = 'Sutton' AND a.FirstName = 'Michael' MATCH (a)-[:ADMITTED_BY]-(bar:Admission) RETURN bar;" },
            { question: 'What state bar has Sarah Primrose been admitted?', answer: "MATCH (a:Applicant) WHERE a.LastName = 'Primrose' AND a.FirstName = 'Sarah' MATCH (a)-[:ADMITTED_BY]-(bar:Admission) RETURN bar;" },
            { question: 'What state bar has Philip Wong been admitted?', answer: "MATCH (a:Applicant) WHERE a.LastName = 'Wong' AND a.FirstName = 'Philip' MATCH (a)-[:ADMITTED_BY]-(bar:Admission) RETURN bar;" },
            { question: 'What state bar has Samuel Lipson been admitted?', answer: "MATCH (a:Applicant) WHERE a.LastName = 'Lipson' AND a.FirstName = 'Samuel' MATCH (a)-[:ADMITTED_BY]-(bar:Admission) RETURN bar;" },
            { question: 'What law school did Joshua E Spielman attend?', answer: "MATCH(a2:Applicant) where a2.LastName ='Spielman' and a2.FirstName ='Joshua' and a2.MiddleName = 'E' MATCH (a2)-[:STUDIED_AT]-(s:School) Return s LIMIT 1" },
            { question: 'What law school did Matthew Wochok attend?', answer: "MATCH(a2:Applicant) where a2.LastName ='Wochok' and a2.FirstName ='Matthew'  MATCH (a2)-[:STUDIED_AT]-(s:School) Return s LIMIT 1" },
            { question: 'Who studied at Harvard?', answer: "MATCH (s:School)-[:STUDIED_AT]-(a2:Applicant) WHERE s.OriginalName ='Harvard' return a2 LIMIT 25" },
            ...
            { question: 'What candidate earned their undergraduate degree from U OF GEORGIA and graduated from Duke in 2015?', answer: "MATCH (s:School)-[:STUDIED_AT]-(a2:Applicant) WHERE s.OriginalName ='Duke' MATCH (a2: Applicant) where a2.JdYear=2015 MATCH (a2: Applicant) where a2.Undergrad='U OF GEORGIA' return a2, s LIMIT 25" },
            ...
            { question: 'What candidate earned their undergraduate degree from U OF DELAWARE at Gibbons law firm?', answer: "MATCH (lf:LawFirm)-[:WORKS_AT]-(a2:Applicant) WHERE lf.Name ='Gibbons' MATCH (a2: Applicant) where a2.Undergrad='U OF DELAWARE' Return a2 LIMIT 25" },
            { question: 'What candidate earned their undergraduate degree from U OF GEORGIA at Morris Manning & Martin LLP law firm?', answer: "MATCH (lf:LawFirm)-[:WORKS_AT]-(a2:Applicant) WHERE lf.Name ='Morris Manning & Martin LLP' MATCH (a2:Applicant) where a2.Undergrad='U OF GEORGIA' Return a2 LIMIT 25" },
            ...
            { question: 'Who at Gibbons law firm graduated law school at Seton Hall in 2012?', answer: "MATCH (lf:LawFirm)-[:WORKS_AT]-(a2:Applicant) WHERE lf.Name ='Gibbons' MATCH (s:School)-[:STUDIED_AT]-(a2:Applicant) WHERE s.OriginalName ='Seton Hall' MATCH (a2: Applicant) where a2.JdYear=2012 return a2, s LIMIT 25" },
